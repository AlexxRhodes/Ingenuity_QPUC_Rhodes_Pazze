...
const QString PARENT_SYNTAX {".."};
const QString COMPONENT_SYNTAX {"#"};
const QString PATH_SEPARATOR_SYNTAX {"/"};
const QString ACTION_SEPARATOR_SYNTAX {"="};
const QString ALL_SYNTAX {"*"};
...
{
    for(auto obj : std::as_const(_objects))
    {
        if(obj != nullptr)
        {
